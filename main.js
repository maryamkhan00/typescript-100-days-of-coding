...
let message = ' once said,"Simplicity is the ultimate sophistication"';
...
let favTransport = ["jeep", "motorcycle", "car"];
...
let invitee = ["Leonardo da Vinci", "Fyodor Dostoevsky", "Dazai Osamu"];
...
let notAttending = "Leonardo da Vinci";
console.log(notAttending + " is unable to attend the dinner.");
let newInvitee = "Albert Einstein";
...
let travelSpots = ["Japan", "Germany", "Iceland", "Italy", "Norway"];
...
let guests = ["Akutagawa Ryunosuke", "Fyodor Dostoevsky", "Ranpo Edogawa", "Dazai Osamu", "Edgar Allan Poe"];
...
/* Q20) Think of something you could store in an array. For example, you could make a list of mountains, rivers,
 ...
 these items. */
let languages = ["Japanese", "German", "Chineese", "Arabic"];
...
let author = "Akutagawa Ryunosuke";
...
console.log(false || false); //false
let foods = ["pizza", "burger", "tacos", "nachos"];
...
let favorite_fruits = ["strawberry", "kiwi", "orange"];
...
let user = ["admin", "ted", "alex", "jake", "ben"];
user.forEach(user => {
    if (user === "admin") {
